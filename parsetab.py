...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','main.py',64),
  ('statement -> expression','statement',1,'p_statement_expr','main.py',69),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','main.py',74),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','main.py',75),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','main.py',76),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','main.py',77),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','main.py',89),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','main.py',94),
  ('expression -> NUMBER','expression',1,'p_expression_number','main.py',99),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',104),
]
