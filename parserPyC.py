...
class PyCParser:
    ...
    def p_program_component(self, p):
        """program_component : program_item
                             | COMMENT
                             | PREPROCESSOR_LINE"""

        p[0] = p[1]

    def p_program_item(self, p):
        """program_item : declaration_statement
    ...
    def p_while_loop_statement(self, p):
        """while_loop_statement : WHILE L_BRACKET logical_expression R_BRACKET statements_block
                                | WHILE L_BRACKET value_expression R_BRACKET statements_block"""
